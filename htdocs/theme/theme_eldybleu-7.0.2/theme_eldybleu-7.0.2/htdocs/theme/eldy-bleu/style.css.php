 ...
 * Copyright (C) 2018		Jean-Philippe Delor		    <jeanphilippe@powerhebergement.com>
...
/**
 *		\file       htdocs/theme/eldy-bleu/style.css.php
 *		\brief      File for CSS style sheet eldy-bleu
 */
...
$heightmenu=56;			/* height of top menu, part with image */
...
.bodylogin
{
background:url("../eldy/img/Bg-login.jpg") no-repeat center fixed; 
	display: table;
    position: absolute;
    height: 100%;
    width: 100%;
...
{
    font-family: <?php print $fontlist ?>;
    font-weight: <?php echo $useboldtitle?'bold':'bold'; ?>;
    vertical-align: middle;
    height: 26px;
}
